...
AIC <- c(AIC.2,AIC.3,AIC.4,AIC.5, AIC.6)
BIC <- c(BIC.2,BIC.3,BIC.4,BIC.5, BIC.6)
llik <- c(llik.2,llik.3,llik.4,llik.5, llik.6)
chi.cuadrado <- c(chisq.2,chisq.3,chisq.4,chisq.5, chisq.6)
G2 <- c(G.2,G.3,G.4,G.5, G.6)
N <- c(n.obs2,n.obs3,n.obs4,n.obs5, n.obs6)
Modelos <- c("2 clases", "3 clases", "4 clases", "5 clases", "6 clases")
