...
data_proc <- data_proc %>% 
  mutate_at(vars(-c(exp, id)), ~(as.numeric(.))) %>%  
  mutate(ingresos = case_when(ingresos <= 291974 ~ "$0 a $291.974",
                              ...
                              TRUE ~ NA_character_),
         edad = car::recode(.$tramo_edad, recodes = "(1) = '15 a 19 años'; c(2, 3) = '20 a 29 años'; c(4, 5, 6, 7) = '25 a 49 años'; c(8, 9, 10) = '50 a 64 años'; c(11, 12) = '65 años o mas'"),
